...
export function CookiesPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      body: `EliteQuantFin uses cookies and similar technologies (such as web beacons, pixels, and local storage) to: keep you signed in to your account; remember your preferences and settings; understand how you use the Service; measure the effectiveness of our features; deliver personalised content; and improve overall platform performance and security.`,
    },
    {
